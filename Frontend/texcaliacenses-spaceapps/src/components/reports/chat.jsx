...
export default function Chat({ messages, setMessages, setShowChat }) {
  ...
  const initialConfig = `Eres un asistente especializado en agricultura y horticultura, diseñado para proporcionar consejos personalizados y responder preguntas sobre prácticas agrícolas óptimas. Utilizas los siguientes datos específicos del usuario y su zona para adaptar tus recomendaciones:
      ...
      Si se te pide información fuera de tu ámbito del sector agricola, indica que no estas diseñado para esas preguntas. Tienes que ser conciso con la información que dices, que las respuestas no pasen de 200 palabras.`;
    ...
    <Card style={{ width: "18rem" }}>
      <CardHeader>
        <div className="flex space-x-1 items-center justify-between w-full">
          ...
          >
            <svg className="size-3.5" viewBox="-0.5 0 25 25" fill="none">
